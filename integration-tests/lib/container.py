...
class ContainerSession:
    ...
    def cleanup_state(self) -> None:
        ...
        Cleanup must ignore missing artefacts but must not paper over failures
        in the helper itself, so we treat the rm/userdel branches as
        best-effort and surface unexpected failures via :meth:`must_run_shell`.
        """
